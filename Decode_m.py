...
import ast
import math
from ShapeFinding_m import YUVtoBGR
from Encode_m import Golomb
...
if __name__ == '__main__':
    os.system('python ShapeFinding_m.py')
    os.system('python CodeProcessing_m.py')
    os.system('python Encode_m.py')
