...
class DetailSearch:
    ...
    def main(self):
        ...
        for f in img_path_total:
            ...
            print('\rDetail layer: Round %d is searching, the number of codewords is %d, program has run %s'
        ...
        output_name = os.path.join(self.output_dir, 'frequency') + '_' + 'detail' + '_' + self.component + '.txt'
...
class RoughSearch:
    ...
    def main(self):
        ...
        for f in img_path_total:
            ...
            print('\rRough Layer: Round %d is searching, the number of codewords is %d, program has run %s'
                  % (search_num, len(self.rough_set), end - self.start), end='')
            search_num = search_num + 1
        output_name = os.path.join(self.output_dir, 'frequency') + '_' + 'rough' + '_' + self.component + '.txt'
...
class ShapeSearch:
    ...
    def main(self):
        ...
        for i in range(round_total):
            ...
            print('\rShape Layer: Round %d is searching, the number of codewords is %d, delete num is %d, '
                  'program has run %s '
