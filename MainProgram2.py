...
if __name__ == '__main__':
    ...
    PreProcess_s.dir_check(frequency_merge_path, empty_flag=True)
    ...
    PreProcess_s.dir_check(codebook_merge_dir, empty_flag=True)
    CodeProcessing_s.CodeProcessing(frequency_merge_path, codebook_merge_dir)
    ...
    for g in os.listdir(input_dir):
        ...
        rate = Encode_s.Encode(codebook_merge_dir, encode_dir, test_encode_dir, pixel_size, layer_shape, rough_height,
                               rough_width, start)
    ...
    for g in os.listdir(os.path.join(output_dir[0])):
        ...
        rate = Decode_s.Decode(codebook_merge_dir, decode_dir, test_decode_dir, original_img_dir, start)
