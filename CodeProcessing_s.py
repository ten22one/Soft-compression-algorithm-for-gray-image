...
def CodeProcessing(input_dir, output_dir):
    ...
    for frequency in os.listdir(input_dir):
        ...
        print('reading codebook %s,' % frequency_name, 'the number of codewords is %d' % len(codebook))
        ...
        output_name = os.path.join(output_dir, 'codebook') + frequency[frequency.rfind('_'):]
